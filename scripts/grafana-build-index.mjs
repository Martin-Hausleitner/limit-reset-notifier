...
push("text", "", [], {
  w: 24, h: 4,
  options: { mode: "markdown", content: "# 🛰️ Mission Control\n🟢 **Agenten live** · ⚡ **aktiv arbeitend** · 💸 **Live-Burn $/15 min** · 💰 **Kosten heute** · 🫀 **Recovery** · ⏱ **Heute gearbeitet** — alles live aus Prometheus. Unten geht's zu den 16 Dashboards." },
});
...
dashlist("🤖 KI-Nutzung & Limits", ["lrn"], { w: 8, h: 13 });
dashlist("🫀 Gesundheit · Zeit · WHOOP", ["aw"], { w: 8, h: 13 });
dashlist("⚡ Agenten — live", ["agents"], { w: 8, h: 6 });
dashlist("📅 Wochen- & Verlauf", ["weekly"], { w: 8, h: 7 });
