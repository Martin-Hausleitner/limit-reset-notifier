...
| Codex  | `…/history/codex.json` → `accounts[]` | `…/cost-usage/codex-v8.json` (fallback: `codex-v6.json`) |
...
Live screenshots of all ten are in the **[Dashboard gallery](#dashboard-gallery)** below
(committed `proof/grafana/lrn-*.png`). The personal-data boards (WHOOP health, time-tracking,
live-agent paths) are *also* captured to `proof/grafana/` but git-ignored — they stay local.
...
ONLY=lrn-exec,lrn-limits,lrn-forecast,lrn-cost,lrn-tokens,lrn-modelmix,lrn-cache,lrn-roles,lrn-trends,lrn-throughput \
  node scripts/grafana-shots.mjs                                            # refresh the 10 public KPI shots + gallery
node scripts/grafana-shots.mjs                                              # all dashboards (health ones stay git-ignored)
```

### Dashboard gallery

<!-- DASHBOARD-SHOTS:START (generated by scripts/grafana-shots.mjs — do not edit by hand) -->
_19 Dashboards · auto-captured from `http://127.0.0.1:3300` · regenerate with `node scripts/grafana-shots.mjs`. Tap any image for full resolution._

#### 0 · Übersicht

[![0 · Übersicht](proof/grafana/lrn-index.png)](proof/grafana/lrn-index.png)

#### 1 · Executive Overview

[![1 · Executive Overview](proof/grafana/lrn-exec.png)](proof/grafana/lrn-exec.png)

#### 2 · Rate-Limits & Resets

[![2 · Rate-Limits & Resets](proof/grafana/lrn-limits.png)](proof/grafana/lrn-limits.png)

#### 3 · Limit-Exhaustion Forecasting

[![3 · Limit-Exhaustion Forecasting](proof/grafana/lrn-forecast.png)](proof/grafana/lrn-forecast.png)

#### 4 · Kosten / FinOps

[![4 · Kosten / FinOps](proof/grafana/lrn-cost.png)](proof/grafana/lrn-cost.png)

#### 5 · Token-Volumen je Typ

[![5 · Token-Volumen je Typ](proof/grafana/lrn-tokens.png)](proof/grafana/lrn-tokens.png)

#### 6 · Model-Mix & Share

[![6 · Model-Mix & Share](proof/grafana/lrn-modelmix.png)](proof/grafana/lrn-modelmix.png)

#### 7 · Cache-Effizienz

[![7 · Cache-Effizienz](proof/grafana/lrn-cache.png)](proof/grafana/lrn-cache.png)

#### 8 · Parent vs Subagent

[![8 · Parent vs Subagent](proof/grafana/lrn-roles.png)](proof/grafana/lrn-roles.png)

#### 9 · Daily & Weekly Trends

[![9 · Daily & Weekly Trends](proof/grafana/lrn-trends.png)](proof/grafana/lrn-trends.png)

#### 10 · Throughput

[![10 · Throughput](proof/grafana/lrn-throughput.png)](proof/grafana/lrn-throughput.png)

#### 11 · WHOOP — Recovery & Schlaf

[![11 · WHOOP — Recovery & Schlaf](proof/grafana/aw-whoop.png)](proof/grafana/aw-whoop.png)

#### 12 · Cognitor — Zeit & Fokus

[![12 · Cognitor — Zeit & Fokus](proof/grafana/aw-computer.png)](proof/grafana/aw-computer.png)

#### 13 · Presence & Training

[![13 · Presence & Training](proof/grafana/aw-presence.png)](proof/grafana/aw-presence.png)

#### 14 · WHOOP — Lab (50+ Visualisierungen)

[![14 · WHOOP — Lab (50+ Visualisierungen)](proof/grafana/aw-whoop-lab.png)](proof/grafana/aw-whoop-lab.png)

#### 15 · Wochen- & Verlaufsübersicht

[![15 · Wochen- & Verlaufsübersicht](proof/grafana/lrn-weekly.png)](proof/grafana/lrn-weekly.png)

#### 16 · KI-Agenten — Live & Verlauf

[![16 · KI-Agenten — Live & Verlauf](proof/grafana/ai-agents.png)](proof/grafana/ai-agents.png)

#### 17 · Cognitor x Health — Tagessteuerung

[![17 · Cognitor x Health — Tagessteuerung](proof/grafana/daily-control.png)](proof/grafana/daily-control.png)

#### 18 · AI Usage Big Display

[![18 · AI Usage Big Display](proof/grafana/ai-big-display.png)](proof/grafana/ai-big-display.png)
